...
def setup():
    ...
    """
    cupidbot = okcupid.OkCupid(SETTINGS.okcupid['mar_smi'],
                      SETTINGS.okcupid['maryrobot'])
    twitterstream = SortedTweeterator(app_key=SETTINGS.twitter['kHiPPaXciS1Ok9ox0PlmJlFFk'],
                                 app_secret=SETTINGS.twitter['8NoL0bBAYIC2XBAGz6tdnrddIYmFQdoZ26RRmVkLj5LAH7yZmt'],
                                 oauth_token=SETTINGS.twitter['805485566418710528-4VPYq7ofCV3KuynzueYK5Ect9nNNYze'],
                                 oauth_token_secret=SETTINGS.twitter['HCQpQhgg6rwxKDqKuEC1ag8a155ALKyrO2nyVypQ6ML4k'],
